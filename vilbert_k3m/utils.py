...
class tbLogger(object):
    def __init__(
        ...
        self.masked_pv_loss = {task_id: 0 for task_id in task_ids}
        self.next_sentense_loss = {task_id: 0 for task_id in task_ids}
        self.next_sentense_loss_pv_v = {task_id: 0 for task_id in task_ids}
        self.next_sentense_loss_pv_t = {task_id: 0 for task_id in task_ids}

        self.masked_t_loss_val = {task_id: 0 for task_id in task_ids}
        self.masked_v_loss_val = {task_id: 0 for task_id in task_ids}
        self.masked_pv_loss_val = {task_id: 0 for task_id in task_ids}
        self.next_sentense_loss_val = {task_id: 0 for task_id in task_ids}
        self.next_sentense_loss_pv_v_val = {task_id: 0 for task_id in task_ids}
        self.next_sentense_loss_pv_t_val = {task_id: 0 for task_id in task_ids}
    ...
    def step_train_CC(
        ...
        masked_loss_pv,
        next_sentence_loss,
        next_sentence_loss_pv_v,
        next_sentence_loss_pv_t,
        norm,
        task_id,
        split,
    ):
        ...
        epochId,
                        ...
                        float(masked_loss_t),
                        float(masked_loss_v),
                        float(masked_loss_pv),
                        float(next_sentence_loss),
                        float(next_sentence_loss_pv_v),
                        float(next_sentence_loss_pv_t),
        ...
        self.masked_pv_loss[task_id] += masked_loss_pv
        self.next_sentense_loss[task_id] += next_sentence_loss
        self.next_sentense_loss_pv_v[task_id] += next_sentence_loss_pv_v
        self.next_sentense_loss_pv_t[task_id] += next_sentence_loss_pv_t
        ...
        self.linePlot(
            stepId, masked_loss_pv, split, self.task_id2name[task_id] + "_masked_loss_pv"
        )
        ...
        self.linePlot(
            ...
            next_sentence_loss_pv_v,
            split,
            self.task_id2name[task_id] + "_next_sentence_loss_pv_v",
        )
        ...
        self.linePlot(
            ...
            next_sentence_loss_pv_t,
            split,
            self.task_id2name[task_id] + "_next_sentence_loss_pv_t",
        )
    ...
    def step_val_CC(
        ...
        self.masked_pv_loss_val[task_id] += masked_loss_pv
        self.next_sentense_loss_val[task_id] += next_sentence_loss
        self.next_sentense_loss_pv_v_val[task_id] += next_sentence_loss_pv_v
        self.next_sentense_loss_pv_t_val[task_id] += next_sentence_loss_pv_t
